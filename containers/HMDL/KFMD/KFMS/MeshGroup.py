...
class MeshGroup(Serializable):
    ...
    def __repr__(self):
        return f"[MeshGroup {self.is_root} {self.ID}] {self.material_offset} {self.unknown_0x0A} {self.mesh_count} {self.mesh_list_offset} {self.kfmg_vertex_offset} {self.vertex_count}"
